...
%%%----------------------------------------------------------------------------
%%% Lädt die passenden Einstellungen
%%%----------------------------------------------------------------------------
\input{./misc/settings}
...
\ifpdf
    ...
    \graphicspath{{abb/png/}}
    \pdfcompresslevel=9
\else
    \usepackage[dvips]{graphicx}
    \graphicspath{{abb/eps/}}
\fi
%%%----------------------------------------------------------------------------
...
\usepackage{layout}
\usepackage{./addons/chngcntr}              % Zähler beeinflussen
\counterwithout{footnote}{chapter}          % Fußnoten durchnummerieren
...
%%%---- ZITIERSTIL --------------------
%%%------------------------------------
%\usepackage{overcite}                      % Zitierstil: Zitate werden hochgestellt
%\renewcommand{\citeleft}{}                 % im Text dargestellt
%\renewcommand{\citeright}{}                %
%
%\makeatletter                              % default:
%\renewcommand{\@cite}[2]{[{#1\if@tempswa , #2\fi}]}     % \renewcommand\@cite[2]{[{\if@tempswa , #2\fi}]}
%\makeatother
%
%\makeatletter                              % plain, ohne Nummern im Verzeichnis
%\renewcommand\@biblabel[1]{$^{}$}          % default: \renewcommand\@biblabel[1]{$^{#1}$}
%\makeatother                               %
%%%---- EO ZITIERSTIL -----------------
...
\begin{figure} [h!]
        \centerline{\includegraphics[width=0.3\textwidth]{./images/CAMPUS_02_Farbe}}
\end{figure}
