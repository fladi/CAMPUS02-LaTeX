...
Ein Vergleich der beiden Verfahren hinsichtlich der ERfüllung von Anforderungen an eine PKI für 
...
\begin{table}
    ...
    \begin{tabularx}{\textwidth}{ l X X }
        ...
        \hline
        \hline
        Verfügbarkeit auf mehr als einer Platform & \CheckedBox & \CheckedBox \\
        \hline
...
eines Verfahrens zur  Zertifikatsverteilungs und Signaturerstellung gewählt werden, die die sozialen Strukturen und Beziehungen dieses Personenkreises wiederspiegelt. Das
sogenannte Web 2.0 basiert hauptsächlich auf der sozialen Verknüpfung von Personen mit Inhalten, dem Finden von Pfaden zu Personen über bereits vorhandene
Kontakte und dem \ldots\todo.
...
integriert sind und über Programmierschnitstellen benutzt werden können. Die institutionalisierte Prüfung der Zertifikatsdaten wäre ein Vorteil von \gls{x509},
...
Bezüglich der sozialen Anforderungen ist \gls{openpgp} jedoch der bessere Kandidat, da es die Einstiegshürden für Benutzer niedriger als bei \gls{x509} hält.
Auch die Abbildung der sozialen Strukturen in einem von privaten Anwendern dominiserten Internet ist mit \gls{openpgp} besser möglich, da das \gls{wot} in
seiner Struktur identisch ist. Ähnlich wie im Web 2.0 beginnt jeder Benutzer im \gls{wot} ohne vorgegebene Vertrauensbeziehungen. Deise werden erst im Lauf der
Zeit, vom Benutzer aktiv angesammelt. Dies würde die Probleme die \gls{x509} durch inkorrekt arbeitende, vorinstallierte \glspl{ca} hat, ausschliessen.
