...
zukünfigte, noch nicht definierte Verhaltensmuster bei \Gls{webbrowser} vorgesehen ist.\\
...
\lstinputlisting[language=HTML,caption={Verwendung von <link>},label=lst:link,emph={link,href},emphstyle=\color{red}\bfseries\emph]{source/link.html}
