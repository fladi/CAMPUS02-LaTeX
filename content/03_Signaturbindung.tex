...
\lstinputlisting[float=bt,language=XML,caption={Beispiel einer Struktur für
\protect\xmlelem{X509Data}},label=lst:xml-dsig-keyinfo-x509,emph={X509Data,X509IssuerSerial,X509SKI,X509Certificate,X509SubjectName}]{source/xml-dsig-keyinfo-x509.xml}
...
Signaturmethode, die Art der Normalisierung der Daten vor der Signierung sowie die Referenzen auf die signierten Daten selbst.
