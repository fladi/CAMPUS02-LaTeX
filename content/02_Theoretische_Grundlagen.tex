...
Der Name der aktuelle Spezifikation für das Datenformat ist \gls{openpgp} und ist im RFC4880 festgelegt. Dabei werden zwei Betreibsarten festgelegt:
\begin{itemize}
    \item Signieren
    \item Verschlüsseln
\end{itemize}

Im Rahmen dieser Arbeit wird nur auf den Signatur-Betreib eingegangen.
\subsection{X.509}
\index{\gls{x509}}
