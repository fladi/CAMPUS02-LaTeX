...
An der Spitze eines solchen Baumes steht eine Root-\gls{ca}, welche die Zertifikate der nächsten, im Baum tiefergelegen Ebene signiert. Jeder Pfad, der von der
Wurzel, der Root-\gls{ca} des Baumesi, zu einem der Zertifikate an einem Ast führt wird als \gls{cot} bezeichnet. \fref{fig:cot} stellt einen solchen Baum mit
