...
\chapter{Bindung an ein \glsentrytext{xhtml}-Dokument}
...
\section{\glsentrytext{http}-Header}
\index{HTTP-Header}
...
\lstinputlisting[language=,
                 caption={Verwendung von \glsentrytext{http}-Header},
...
\section{\glsentrydescplural{xml-ns}}
...
\xmlelem{Signature} auf \fref{lin:xmlns-signature}, wird der Namespace auf den von \gls{xml-dsig} geändert, wobei nun wiederum dieser Namespace auf die unter
...
\lstinputlisting[language=HTML,
                 caption={Verwendung von \glsentrydescplural{xml-ns}},
                 label=lst:xmlns,
...
\lstinputlisting[language=HTML,caption={Verwendung von \glsentrytext{xinclude}},label=lst:xinclude,emph={include,xi}]{source/xinclude.html}
