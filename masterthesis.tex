...
% Für richtige Anfürungszeichen  https://tex.stackexchange.com/questions/150945/automatic-german-quotation-marks
\MakeOuterQuote{"}


\usepackage{sty/pgf-pie}
%http://latex-cookbook.net/articles/pie-chart/
...
%Enable header for first chapter page
%\fancypagestyle{plain}{ %
%  %Page footer
