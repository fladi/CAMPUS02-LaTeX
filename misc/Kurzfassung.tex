...
on the World Wide Web. This work outlines how this can be achieved by the application of "`Digital Signatures in \glstext*{xhtml}"' and deals with the requirements 
that a combination of \glstext*{xhtml} and \glstext*{xml-dsig} imposes. It describes the workings of \glstext*{xml-dsig} and identifies two popular methods
already in use on the Internet for creating digital signatures and distributing certificates, \glstext*{openpgp} and \glstext*{x509}.
Several approaches towards feasible connections between \glstext*{xml-dsig} and \glstext*{xhtml} are introduced. They all aim to indicate the presence of a
digital signature on the level of \glstext*{http}/\glstext*{https} or \glstext*{xhtml}. \glstext*{openpgp} and \glstext*{x509} are weighted against each other
...
add-on for a web browser, faciliating both \glstext*{openpgp} and \glstext*{x509} for its cryptographic functions through an abstract interface.
